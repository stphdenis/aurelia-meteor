define(['exports', 'aurelia-framework', './blaze-adapter'], function (exports, _aureliaFramework, _blazeAdapter) {
  'use strict';
  ...
  var LoginButtons = exports.LoginButtons = (_class = function (_BlazeAdapter) {
    ...
    return LoginButtons;
  }(_blazeAdapter.BlazeAdapter), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'align', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});