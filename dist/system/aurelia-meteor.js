...
System.register(['meteor/blaze', 'meteor/templating', 'aurelia-framework'], function (_export, _context) {
  ...
  var Blaze, Template, inject, inlineView, bindable, _dec, _dec2, _class, _desc, _value, _class3, _descriptor, BlazeAdapter, LoginButtons;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('LoginButtons', LoginButtons = (_class3 = function (_BlazeAdapter) {
        ...
        return LoginButtons;
      }(BlazeAdapter), (_descriptor = _applyDecoratedDescriptor(_class3.prototype, 'align', [bindable], {
        enumerable: true,
        initializer: null
      })), _class3));
